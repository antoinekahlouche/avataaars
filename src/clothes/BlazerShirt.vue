<template>
	<g id="Clothing/BlazerShirt" transform="translate(0.000000, 170.000000)">
		<defs>
			<path
		...
		<g id="Shirt" transform="translate(32.000000, 29.000000)">
			...
			<use id="Clothes" fill="#E6E6E6" :xlink:href="selector(path1)" />
			<g id="Color" :mask="url(mask1)" fill="#262E33">
				<g id="Color" transform="translate(-32.000000, -29.000000)">
					<rect x="0" y="0" width="264" height="110" />
				</g>
			</g>
			<g id="Shadowy" opacity="0.599999964" :mask="url(mask1)" fill-opacity="0.16" fill="#000000">
				<g id="Hola" transform="translate(60.000000, -25.000000)">
