		...
		<g id="LongHairMiaWallace" :mask="url(mask1)">
			<g transform="translate(-1.000000, 0.000000)">
				...
				<g id="Hair" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(40.000000, 19.000000)">
					...
					<use id="CombinedShape" fill="#E6E6E6" :xlink:href="selector(path2)" />
					<HairColor :maskID="mask2" :color="color" />
				</g>
