<template>
	<g id="Top" stroke-width="1" fill-rule="evenodd">
		<defs>
			...
			<filter x="-0.8%" y="-2.0%" width="101.5%" height="108.0%" filter-units="objectBoundingBox" :id="filter1">
		...
		<g id="Hat" :mask="url(mask1)">
			<g transform="translate(-1.000000, 0.000000)">
				<g id="Hat" stroke-width="1" fill-rule="evenodd" transform="translate(1.000000, 0.000000)">
					...
					<g id="MaskHair" />
					<path d="M123.182388,2 L141.817612,2 L141.817612,2 C160.609055,2 176.866947,15.0804442 180.890118,33.4361631 L190,75 L75,75 L84.1098821,33.4361631 L84.1098821,33.4361631 C88.1330533,15.0804442 104.390945,2 123.182388,2 Z" fill="#1F333C" :mask="url(mask2)" />
					<ellipse id="Hipster" fill="#1F333C" :mask="url(mask2)" cx="132" cy="87.5" rx="122" ry="57.5" />
					<ellipse id="Very" fill="#15232A" :mask="url(mask2)" cx="132" cy="82" rx="62" ry="25" />
				</g>
