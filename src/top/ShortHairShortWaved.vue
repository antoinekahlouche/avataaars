<template>
	<g id="Top" stroke-width="1" fill-rule="evenodd">
		...
		<g id="Mask" />
		<g id="ShortHairShortWaved" :mask="url(mask2)">
			<g transform="translate(-1.000000, 0.000000)">
				<slot name="FacialHair" />
				<mask :id="mask1" fill="white">
					<use :xlink:href="selector(path1)" />
				</mask>
				<use id="ShortHair" stroke="none" fill="#28354B" fill-rule="evenodd" :xlink:href="selector(path1)" />
				<HairColor :maskID="mask1" :color="color" />
