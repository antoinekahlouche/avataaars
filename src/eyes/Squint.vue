<template>
	<g id="Eyes/Squint" transform="translate(0.000000, 8.000000)">
		...
		<g id="Eye" transform="translate(16.000000, 13.000000)">
			...
			<use id="The-white-stuff" fill="#FFFFFF" :xlink:href="selector(path1)" />
			<circle fill-opacity="0.699999988" fill="#000000" :mask="url(mask1)" cx="14" cy="10" r="6" />
		</g>
		<g id="Eye" transform="translate(68.000000, 13.000000)">
			<mask id="{mask2}" fill="white">
				<use :xlink:href="selector(path2)" />
			</mask>
			<use id="Eyeball-Mask" fill="#FFFFFF" :xlink:href="selector(path2)" />
			<circle fill-opacity="0.699999988" fill="#000000" mask="{`url(#${mask2})`}" cx="14" cy="10" r="6" />
		</g>
	</g>
</template>
